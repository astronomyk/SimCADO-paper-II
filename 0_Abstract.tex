...
{We show that MICADO on the ELT will be able to probe the IMF of star clusters 10$\times$ denser than what JWST will be able to access, and over 100$\times$ denser than those imaged by Hubble. While the sensitivity of MICADO will not allow us to study the brown dwarf regime outside the Milky Way, it will enable access to all stellar members of over 1000 young clusters in the Milky Way and the Magellanic clouds. \rewrite !!ADD sentence about Salpeter slope out to 5Mpc!! 
This will pave the way for a true statistical analysis of the IMF under starkly varying environmental conditions.}
